...
void GameMap::LoadMap(std::string name)
{
	...
	// max_x_ , max_y_ sẽ được tọa độ max map
...
void GameMap::LoadTiles(SDL_Renderer* screen) // load image cho image tương ứng
{
	char file_img[30];
	FILE* fp = NULL;
	for (int i = 0; i < MAX_TILES; i++)
	{
		sprintf_s(file_img, "map/%d.png", i); // chuyển đổi chỉ số i vào chuỗi "map/%d.png"
